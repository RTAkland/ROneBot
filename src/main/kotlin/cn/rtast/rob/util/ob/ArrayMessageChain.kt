...
class ArrayMessageChain internal constructor(arrayMessageList: List<BaseArrayMessage>) {
    ...
    class Builder {
        ...
        fun build(): ArrayMessageChain {
            return ArrayMessageChain(arrayMessageList)
        }
    }
}