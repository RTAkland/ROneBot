...
internal data class RPS(val type: ArrayMessageType = ArrayMessageType.rps) : BaseSegment()
internal data class DICE(val type: ArrayMessageType = ArrayMessageType.dice) : BaseSegment()
internal data class Shake(val type: ArrayMessageType = ArrayMessageType.shake) : BaseSegment()