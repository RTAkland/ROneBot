...
internal fun EventRegistry.init() {
    ...
    register(
        EventMeta(
            "cn.rtast.rob.milky.event.milky.BotInstanceCreatedEvent",
            setOf(Topics.SYSTEM, "初始化"),
            "Bot初始化"
        )
    )
    ...
    register(
        EventMeta(
            "cn.rtast.rob.milky.event.milky.BotInstanceDisposedEvent",
            setOf(Topics.SYSTEM, "释放", "退出"),
            "Bot被释放"
        )
    )
    ...
    register(
        EventMeta(
            "cn.rtast.rob.milky.event.ws.packed.BotOfflineEvent",
            setOf(Topics.SYSTEM, "离线"),
            "Bot离线"
        )
    )
    ...
    register(
        EventMeta(
            "cn.rtast.rob.milky.event.ws.packed.FriendFileUploadEvent",
            setOf(Topics.FILE, Topics.FRIEND),
            "好友发送文件"
        )
    )
    ...
    register(
        EventMeta(
            "cn.rtast.rob.milky.event.ws.packed.FriendNudgeEvent",
            setOf(Topics.FILE, Topics.NUDGE, Topics.FRIEND),
            "好友戳一戳"
        )
    )
    ...
    register(
        EventMeta(
            "cn.rtast.rob.milky.event.ws.packed.FriendRequestEvent",
            setOf(Topics.REQUEST, Topics.FRIEND, "加好友"),
            "加好友请求"
        )
    )
    ...
    register(
        EventMeta(
            ...
            setOf(Topics.NOTICE, Topics.GROUP, Topics.CHANGE, "管理员"),
            "群管理员变更"
        )
    )
    ...
    register(
        EventMeta(
            "cn.rtast.rob.milky.event.ws.packed.GroupFileUploadEvent",
            setOf(Topics.FILE, Topics.GROUP),
            "群文件上传"
        )
    )
    ...
    register(
        EventMeta(
            "cn.rtast.rob.milky.event.ws.packed.GroupJoinRequestEvent",
            setOf(Topics.REQUEST, Topics.GROUP, "加群"),
            "加群请求"
        )
    )
    ...
    register(
        EventMeta(
            "cn.rtast.rob.milky.event.ws.packed.GroupMessageEvent",
            setOf(Topics.MESSAGE, Topics.GROUP),
            "群消息"
        )
    )
    ...
    register(
        EventMeta(
            "cn.rtast.rob.milky.event.ws.packed.GroupMuteEvent",
            setOf(Topics.NOTICE, Topics.GROUP, "禁言"),
            "用户被禁言"
        )
    )
    ...
    register(
        EventMeta(
            "cn.rtast.rob.milky.event.ws.packed.GroupNudgeEvent",
            setOf(Topics.NUDGE, Topics.GROUP),
            "群聊戳一戳"
        )
    )
    ...
    register(
        EventMeta(
            "cn.rtast.rob.milky.event.ws.packed.GroupWholeMuteEvent",
            setOf(Topics.NOTICE, Topics.GROUP, "禁言"),
            "全员禁言"
        )
    )
