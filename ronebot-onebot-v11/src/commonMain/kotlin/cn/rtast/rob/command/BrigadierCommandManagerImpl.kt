...
public class BrigadierCommandManagerImpl : BrigadierCommandManager<CommandSource, IBotInstance> {

    private val botInstances: List<IBotInstance> get() = OneBotFactory.botManager.allBots()
