...
<h4>ROneBot: OneBot11 协程异步SDK</h4>
...
> OneBot11模块支持在Cloudflare worker部署Bot

这是一个 `OneBot11` 协程SDK, 支持多实例, 深度依赖Kotlin协程, 以及Kotlin DSL的特性

> ROB在任何平台/模块中都`不使用`反射, 以此为基础获得更好的性能
